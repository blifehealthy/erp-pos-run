...
configure_images() {
  ...
  case "$PRODUCTION_IMAGE_MODE" in
    build)
      BACKEND_IMAGE="${BACKEND_IMAGE:-erp-pos-backend:$version}"
      FRONTEND_IMAGE="${FRONTEND_IMAGE:-erp-pos-frontend:$version}"
      NGINX_IMAGE="${NGINX_IMAGE:-erp-pos-nginx:$version}"
      ;;
    pull)
      ...
      BACKEND_IMAGE="${BACKEND_IMAGE:-$registry/$namespace/erp-pos-backend:$version}"
      FRONTEND_IMAGE="${FRONTEND_IMAGE:-$registry/$namespace/erp-pos-frontend:$version}"
      NGINX_IMAGE="${NGINX_IMAGE:-$registry/$namespace/erp-pos-nginx:$version}"
      ;;
    *)
