...
- [x] Resolve PR41 blocker: PR42 added `/health/live` and `/health/ready`, backend healthcheck passes, and nginx starts in isolated Compose validation
...
- [ ] Confirm `uploads_data` is mounted at `/app/uploads`
