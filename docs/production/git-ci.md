...
PR15 added immutable local image tags with `RELEASE_VERSION`, and PR17 adds a manual GHCR publishing workflow. Production deployment automation is still intentionally absent.
