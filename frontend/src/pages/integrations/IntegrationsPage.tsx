...
const endpointDocs = [
  ...
  ["POST", "/api/public/v1/orders", "รับออเดอร์จากเว็บ"],
  ["GET", "/api/public/v1/orders/{external_order_id}", "ดูสถานะออเดอร์"]
];
...
const webhookExamples = {
  ...
  "order.received": `{
  "external_order_id": "BLIFE-20260514-001",
  "source": "blifehealthy",
  "total_amount": "200.00",
  "items_count": 1
}`
...
export default function IntegrationsPage(): JSX.Element {
  ...
  const externalOrdersQuery = useQuery({
    queryKey: ["integrations", "external-orders", statusFilter],
    queryFn: async () =>
      (await integrationApi.listExternalOrders({ status: statusFilter || undefined, page: 1, limit: 100 })).data.data as ExternalOrder[]
  });
      ...
      <Tabs defaultValue="api-keys" className="space-y-6">
        ...
        <TabsContent value="docs">
          <div className="grid gap-6">
            ...
            <Card>
              <CardContent className="space-y-3 p-5">
                <h3 className="text-lg font-semibold">blifehealthy.com Integration</h3>
                <p className="font-mono text-sm">POST /webhooks/blifehealthy/orders</p>
                <p className="text-sm text-gray-500">Signature header: X-Blife-Signature</p>
                <pre className="overflow-x-auto rounded-lg bg-slate-950 p-4 text-sm text-slate-100">
