...
export default function TopBar({ title, onMenuClick }: TopBarProps): JSX.Element {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 shadow-sm md:px-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-lg font-bold text-blue-600">ERP-POS</p>
          <p className="hidden text-sm text-gray-500 md:block">{title}</p>
        </div>
      </div>
